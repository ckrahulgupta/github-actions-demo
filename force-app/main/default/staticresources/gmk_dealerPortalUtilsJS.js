...
((portalext) => {
    ...
    $(document).ready(function () {
		...
		function disableCutCopyPaste() {
			const inputSelectors = [
				...
				'div[data-style-actor-name="gmk_dealerPortalAddNewApplicant"] div[data-style-field-name="Fed_Tax_ID"] input',
				'div[data-style-actor-name="gmk_dealerPortalAddNewApplicant"] div[data-style-field-name="Confirm_Fed_Tax_ID"] input',
	
				// SSN and Confirm SSN fields on initiate application form
				'div[data-style-actor-name="gmk_dealerPortalAddNewApplicant"] div[data-style-field-name="SSN"] input',
				'div[data-style-actor-name="gmk_dealerPortalAddNewApplicant"] div[data-style-field-name="Confirm_SSN"] input',
	
				// Fed Tax ID and Confirm Fed Tax ID fields on business information form
				'div[data-style-actor-name="gmk_dealerPortalPrimaryApplicantBusinessInformation"] div[data-style-field-name="clcommon__Account__r_genesis__Business_Information__r_genesis__Tax_Identification_Number__c"] input',
				'div[data-style-actor-name="gmk_dealerPortalPrimaryApplicantBusinessInformation"] div[data-style-field-name="clcommon__Account__r_genesis__Business_Information__r_Confirm_Tax_Identification_Number__c"] input',
	
				// SSN and Confirm SSN fields on individual information form
				'div[data-style-actor-name="gmk_dealerPortalPrimaryApplicantIndividualInformation"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
				'div[data-style-actor-name="gmk_dealerPortalPrimaryApplicantIndividualInformation"] div[data-style-field-name="clcommon__Contact__r_Confirm_SSN__c"] input',
	
				// SSN and Confirm SSN fields on co-applicant information form
				'div[data-style-actor-name="gmk_dealerPortalCoApplicantInformation"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
				'div[data-style-actor-name="gmk_dealerPortalCoApplicantInformation"] div[data-style-field-name="clcommon__Contact__r_Confirm_SSN__c"] input',

				// SSN and Confirm SSN fields on add new co-applicant form
				'div[data-style-actor-name="gmk_dealerPortalAddNewCoApplicantContainer"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
				'div[data-style-actor-name="gmk_dealerPortalAddNewCoApplicantContainer"] div[data-style-field-name="clcommon__Contact__r_Confirm_SSN__c"] input',
	
				// SSN field on spouse information list
				'div[data-style-actor-name="gmk_dealerPortalSpouseInformationList"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input'
			];
	...
	window.addEventListener("DOMNodeInserted", (event) => {
		var $inputs = $(
			'[data-style-actor-name="gmk_dealerPortalApplicationTabs"] input'
		);

		var $dropdowns = $(
			'[data-style-actor-name="gmk_dealerPortalApplicationTabs"] .MuiSelect-root'
		);
