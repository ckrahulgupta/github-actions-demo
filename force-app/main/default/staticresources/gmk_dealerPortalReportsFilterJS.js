/**
 * @author          Rahul Gupta
 * @description     Used to dynamically inject report filter options on the portal
 * @created         17.08.2022
 * @lastmodified    11.09.2023
 */

const reportsfilter = (function () {
...
(function (portalext, $) {
	...
	portalext.getReportFilters = reportsfilter.getReportFilters;
	portalext.getCurrentMonthAndYear = reportsfilter.getCurrentMonthAndYear;
	portalext.getCurrentYear = reportsfilter.getCurrentYear;
	portalext.getCalendarYearFilters = reportsfilter.getCalendarYearFilters;
	portalext.getCurrentCropYear = reportsfilter.getCurrentCropYear;
	portalext.addOptionInDropdown = reportsfilter.addOptionInDropdown;
