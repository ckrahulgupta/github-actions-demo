    ...
    $(document).ready(function () {
		...
		function disableCutCopyPaste() {
			const inputSelectors = [
                ...
                'div[data-style-actor-name="gmk_growerPortalAddNewApplicant"] div[data-style-field-name="Fed_Tax_ID"] input',

                // fed tax id field on initiate application form
                'div[data-style-actor-name="gmk_growerPortalAddNewApplicant"] div[data-style-field-name="Confirm_Fed_Tax_ID"] input',

                // ssn field on initiate application form
                'div[data-style-actor-name="gmk_growerPortalAddNewApplicant"] div[data-style-field-name="SSN"] input',
    
                // confirm ssn field on initiate application form
                'div[data-style-actor-name="gmk_growerPortalAddNewApplicant"] div[data-style-field-name="Confirm_SSN"] input',

                // ssn field on grower portal register form
                'div[data-style-actor-name="gmk_growerPortalRegistrationForm"] div[data-style-field-name="SSN"] input',

                // confirm ssn field on portal register form
                'div[data-style-actor-name="gmk_growerPortalRegistrationForm"] div[data-style-field-name="Confirm_SSN"] input',
    
                // fed tax id field on business information form
                'div[data-style-actor-name="gmk_growerPortalPrimaryApplicantBusinessInformation"] div[data-style-field-name="clcommon__Account__r_genesis__Business_Information__r_genesis__Tax_Identification_Number__c"] input',
    
                // confirm fed tax id field on business information form
                'div[data-style-actor-name="gmk_growerPortalPrimaryApplicantBusinessInformation"] div[data-style-field-name="clcommon__Account__r_genesis__Business_Information__r_Confirm_Tax_Identification_Number__c"] input',
                
                // ssn field on individual information form
                'div[data-style-actor-name="gmk_growerPortalPrimaryApplicantIndividualInformation"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
                
                // confirm ssn field on individual information form
                'div[data-style-actor-name="gmk_growerPortalPrimaryApplicantIndividualInformation"] div[data-style-field-name="clcommon__Contact__r_Confirm_SSN__c"] input',
                
                // ssn field on co-applicant information form
                'div[data-style-actor-name="gmk_growerPortalCoApplicantInformation"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
                
                // confirm ssn field on co-applicant information form
                'div[data-style-actor-name="gmk_growerPortalCoApplicantInformation"] div[data-style-field-name="clcommon__Contact__r_Confirm_SSN__c"] input',
                
                // ssn field on spouse information list
                'div[data-style-actor-name="gmk_growerPortalSpouseInformationList"] div[data-style-field-name="clcommon__Contact__r_genesis__SSN__c"] input',
                
                // ssn field on profile information
                'div[data-style-actor-name="gmk_growerPortalWritePersonalInformation"] div[data-style-field-name="genesis__SSN__c"] input'
			];
